...
class SanityTester:
    ...
    def test_server_health(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_stats(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_health(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_search_empty(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_search_query(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_movie_details(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_explore(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_explore_filters(self) -> Tuple[bool, str, Optional[str]]:
        ...
        if failed_filters:
            return False, f"Some filters failed", "\n".join(failed_filters)
        
        return True, f"All {len(passed_filters)} filters working", None
    
    def test_playlists(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_playlist_detail(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_history(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_launch_history(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_currently_playing(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_random_movie(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_language_counts(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_vlc_test(self) -> Tuple[bool, str, Optional[str]]:
        """Test: VLC detection"""
        ...
        return False, f"VLC not found", str(data.get("errors", []))
    
    def test_ffmpeg_test(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_vlc_launch(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_vlc_launch_with_timestamp(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_all_movies(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_duplicates(self) -> Tuple[bool, str, Optional[str]]:
    ...
    def test_hidden_movies(self) -> Tuple[bool, str, Optional[str]]:
